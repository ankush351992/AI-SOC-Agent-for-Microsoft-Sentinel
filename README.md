...
- 📄 **Executive Briefing Export Suite:** Instant 1-click exports of publication-ready Executive Incident Reports in **PDF** (WeasyPrint formatted), **Markdown**, and **JSON** with dynamic AI model stamps and signature hash.
